...
@Document(collection = "TariffCustomers")
public class MongoTariffCustomer implements TariffCustomer, IdEntity {
    ...
    public MongoTariffCustomer(String id, String name, String login) {
        this(name, login);
        this.id = id;
    }
    
    public MongoTariffCustomer(String name, String login) {
        super();
        this.login = login;
        this.name = name;
    }
    
    public MongoTariffCustomer() {
